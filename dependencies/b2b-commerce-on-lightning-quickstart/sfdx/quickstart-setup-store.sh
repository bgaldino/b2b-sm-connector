...
echo "newRoleId: $newRoleID"
username=`sfdx force:user:display | grep "Username" | sed 's/Username//g;s/^[[:space:]]*//g'`
echo "username: $username"

sfdx force:data:record:update -s User -v "UserRoleId=$newRoleID CountryCode='US' StateCode='AL'" -w "Username=$username"
...
then
	...
	sfdx force:data:record:create -s ContactPointAddress -v "AddressType='Shipping' ParentId='$accountID' ActiveFromDate='2020-01-01' ActiveToDate='2040-01-01' City='Vancouver' CountryCode='US' IsDefault='false' Name='Non-Default Shipping' PostalCode='94105' StateCode='CA' Street='415 Mission Street (Shipping)'"
	sfdx force:data:record:create -s ContactPointAddress -v "AddressType='Billing' ParentId='$accountID' ActiveFromDate='2020-01-01' ActiveToDate='2040-01-01' City='Vancouver' CountryCode='US' IsDefault='false' Name='Non-Default Billing' PostalCode='94105' StateCode='CA' Street='415 Mission Street (Billing)'"
else
